...
from components.target import draw_target
from components.arena import draw_scenario
from components.arena import draw_floor
from components.texture import load_texture
from components.luz import setup_lighting
...
def draw():
    texture = load_texture('components\gra.jpg')
    texture1 = load_texture('components\wall.png')
    ...
    draw_scenario(*sphere_positions[current_sphere_index], texture1)
